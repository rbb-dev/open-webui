...
AUDIO_RT_SERVER_VAD_PREFIX_PADDING_MS = ConfigVar(
...
AUDIO_RT_CONTEXT_MAX_HISTORY_EXCHANGES = ConfigVar(
...
AUDIO_RT_CONTEXT_MAX_HISTORY_BYTES = ConfigVar(
...
AUDIO_RT_CONTEXT_SUMMARIZE = ConfigVar(
...
AUDIO_RT_CONTEXT_UNANSWERED_LAST_USER_TURN = ConfigVar(
...
AUDIO_RT_CONTEXT_SUMMARY_PROMPT = ConfigVar(
...
AUDIO_RT_CONTEXT_SUMMARY_MAX_SIZE = ConfigVar(
...
AUDIO_RT_VAD_INTERRUPT_RESPONSE = ConfigVar(
...
AUDIO_RT_IDLE_CALL_CHECKIN_PROMPT = ConfigVar(
...
AUDIO_RT_TRUNCATION_TOKEN_LIMIT = ConfigVar(
