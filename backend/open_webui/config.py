...
USER_PERMISSIONS_REALTIME_SETTINGS_NOISE_REDUCTION = (
    os.environ.get('USER_PERMISSIONS_REALTIME_SETTINGS_NOISE_REDUCTION', 'True').lower() == 'true'
)
USER_PERMISSIONS_REALTIME_SETTINGS_MAX_TOKENS = (
    os.environ.get('USER_PERMISSIONS_REALTIME_SETTINGS_MAX_TOKENS', 'True').lower() == 'true'
)
USER_PERMISSIONS_REALTIME_SETTINGS_CONTEXT = (
    os.environ.get('USER_PERMISSIONS_REALTIME_SETTINGS_CONTEXT', 'False').lower() == 'true'
)
