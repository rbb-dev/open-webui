...
def build_realtime_admin_config(app_config: Any, *, include_task_model_warning: bool = True) -> dict[str, Any]:
...
def get_realtime_task_model_warning(app_config: Any) -> bool:
    return getattr(app_config, 'AUDIO_RT_ENGINE', '') == 'openai' and not getattr(app_config, 'TASK_MODEL_EXTERNAL', '')
