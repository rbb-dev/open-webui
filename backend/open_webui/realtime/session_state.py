...
class RealtimeSession:
    ...
    async def send_event(self, event_type: str, payload: Optional[dict] = None, context: Optional[str] = None) -> None:
        if not self.ws:
            return
    ...
    async def apply_setting(self, setting: str, value, sio=None) -> None:
        ...
        if setting == 'speed':
            ...
            session_update.setdefault('audio', {}).setdefault('input', {})['turn_detection'] = turn_detection
...
class SessionManager:
    def __init__(self):
        ...
        self.session_end_background_tasks: Optional[Callable[[RealtimeSession], Awaitable[None]]] = None
    ...
    async def teardown_session(self, session_id: str, reason: str = 'user', sio=None) -> Optional[RealtimeSession]:
...
async def end_session(session: RealtimeSession, sio, reason: str, message: Optional[str] = None) -> None:
